...
for p in [1,2,3]:
	for m in [16,32,128]:
		for Re in [7500,10000]:
			...
			upvd = PVDReader(registrationName='u.pvd', FileName='/Users/gxt/Desktop/My_Computer/open-sources/SS-Div-Conforming-B-splines-Incompressible-NS/Lid2D/NM_results/nm_Re='+str(Re)+'_p='+str(p)+'_m='+str(m)+'/u.pvd')
			...
			# save data
			SaveData('/Users/gxt/Desktop/My_Computer/open-sources/SS-Div-Conforming-B-splines-Incompressible-NS/Lid2D/NM_results/nm_Re='+str(Re)+'_p='+str(p)+'_m='+str(m)+'/u-xy.csv', proxy=upvd, PointDataArrays=['u_sol'])

			# create a new 'PVD Reader'
			vpvd = PVDReader(registrationName='v.pvd', FileName='/Users/gxt/Desktop/My_Computer/open-sources/SS-Div-Conforming-B-splines-Incompressible-NS/Lid2D/NM_results/nm_Re='+str(Re)+'_p='+str(p)+'_m='+str(m)+'/v.pvd')
			...
			# save data
			SaveData('/Users/gxt/Desktop/My_Computer/open-sources/SS-Div-Conforming-B-splines-Incompressible-NS/Lid2D/NM_results/nm_Re='+str(Re)+'_p='+str(p)+'_m='+str(m)+'/v-xy.csv', proxy=vpvd, PointDataArrays=['v_sol'])
